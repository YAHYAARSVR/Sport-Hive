...
class _BadmintonPageState extends State<BadmintonPage> with SingleTickerProviderStateMixin {
  ...
  final List<int> capacities = [24, 24, 24, 24, 24];

  final List<String> matchImages = [
    "images/badminton1.jpeg",
    "images/badminton2.png",
    "images/badminton3.jpeg",
    "images/badminton4.jpeg",
    "images/badminton5.jpeg",
  ];

  final List<String> mapLocations = [
    "https://maps.app.goo.gl/badminton1",
    "https://maps.app.goo.gl/badminton2",
    "https://maps.app.goo.gl/badminton3",
    "https://maps.app.goo.gl/badminton4",
    "https://maps.app.goo.gl/badminton5",
  ];
  ...
  Future<void> ensureMatchesExist() async {
    for (int dayIndex = 0; dayIndex < fullDates.length; dayIndex++) {
      for (int matchIndex = 0; matchIndex < 5; matchIndex++) {
        ...
        final stadium = "National Badminton Arena";
          ...
          if (date == fullDates[dayIndex]) {
            for (int matchIndex = 0; matchIndex < 5; matchIndex++) {
              if (_getMatchTime(matchIndex) == time &&
                  location == "National Badminton Arena") {
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Badminton Matches', style: TextStyle(color: Colors.white)),
            centerTitle: true,
          ...
          bottomNavigationBar: BottomNavigationBar(
            ...
            items: const [
              ...
              BottomNavigationBarItem(icon: Icon(Icons.sports_tennis), label: 'Fields'),
              ...
              final docs = snapshot.data!.docs.where((doc) {
                try {
                  ...
                  return docDate.day == selectedDate.day &&
                      ...
                      doc['location'] == "National Badminton Arena";
                } catch (_) {
                  return false;
                }
              }).toList();
  ...
  Widget _buildMatchCard({
    ...
    final capacity = int.tryParse(players[1]) ?? 24;
    final gender = initialData['gender'] ?? 'Male';
