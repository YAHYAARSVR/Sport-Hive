...
class _TennisPageState extends State<TennisPage> with SingleTickerProviderStateMixin {
  ...
  final List<int> capacities = [4, 2, 4, 2, 4];
  ...
  final List<String> mapLocations = [
    "https://maps.app.goo.gl/tennis1",
    "https://maps.app.goo.gl/tennis2",
    "https://maps.app.goo.gl/tennis3",
    "https://maps.app.goo.gl/tennis4",
    "https://maps.app.goo.gl/tennis5",
  ];
  ...
  Future<void> ensureMatchesExist() async {
    for (int dayIndex = 0; dayIndex < fullDates.length; dayIndex++) {
      for (int matchIndex = 0; matchIndex < 5; matchIndex++) {
        ...
        final stadium = "National Tennis Arena";
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Tennis Matches', style: TextStyle(color: Colors.white)),
            centerTitle: true,
              ...
              final docs = snapshot.data!.docs.where((doc) {
                try {
                  ...
                  return docDate.day == selectedDate.day &&
                      ...
                      doc['location'] == "National Tennis Arena";
                } catch (_) {
                  return false;
                }
              }).toList();
  ...
  Widget _buildMatchCard({
    ...
    final capacity = int.tryParse(players[1]) ?? 4;
    final teamInfo = matchIndex.isEven ? 'Tennis Club A' : 'Tennis Club B';
